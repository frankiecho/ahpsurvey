...
[![license](https://img.shields.io/github/license/mashape/apistatus.svg)](https://choosealicense.com/licenses/mit/) [![Rdoc](http://www.rdocumentation.org/badges/version/ahpsurvey)](http://www.rdocumentation.org/packages/ahpsurvey) [![CRAN_time_from_release](http://www.r-pkg.org/badges/ago/ahpsurvey)](https://cran.r-project.org/package=ahpsurvey) 
...
[![Codecov test coverage](https://codecov.io/gh/frankiecho/ahpsurvey/graph/badge.svg)](https://app.codecov.io/gh/frankiecho/ahpsurvey)
<!-- badges: end -->
