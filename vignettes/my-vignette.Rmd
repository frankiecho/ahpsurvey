...
subtitle: 'Vignettes for the `ahpsurvey` package (ver 0.2.2)'
author: 
- name: Frankie Cho
...
```{r, fig.height=4, fig.width=7, fig.cap="\\label{fig:figs}Individual priority weights with respect to goal (1 iteration)"}
it <- 1
thres <- 0.1
